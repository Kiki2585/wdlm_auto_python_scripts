...
1. Put your info into "account_names.txt" with the following format:
   
  window_name_you_wanna_have account_name
  
and it does the rest. you can add more if needed.

2. you can also add other keys to get more named windows and more accounts.
